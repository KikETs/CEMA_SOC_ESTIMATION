...
BASE_PREFIX = "nmc_goal_vcorr_it_h64_w50_profile_invariant_seed0"
...
def invariant_variants() -> list[InvariantVariant]:
    return [
        InvariantVariant("adv_tempmix_mlp_lstm2_a0p02_w25x2", recurrent="lstm", layers=2, head_kind="mlp", temp_mode="moe", lambda_adv=0.02, weight_25=2.0),
        InvariantVariant("adv_tempmix_mlp_lstm2_a0p05_w25x2", recurrent="lstm", layers=2, head_kind="mlp", temp_mode="moe", lambda_adv=0.05, weight_25=2.0),
        InvariantVariant("adv_tempmix_linear_lstm2_a0p05_w25x2", recurrent="lstm", layers=2, head_kind="linear", temp_mode="moe", lambda_adv=0.05, weight_25=2.0),
        InvariantVariant("adv_tempbias_mlp_lstm2_a0p05_w25x2", recurrent="lstm", layers=2, head_kind="mlp", temp_mode="bias", lambda_adv=0.05, weight_25=2.0),
        InvariantVariant("adv_tempmix_linear_tcn5_a0p05_w25x2", recurrent="tcn", layers=5, head_kind="linear", temp_mode="moe", dropout=0.04, lambda_adv=0.05, weight_25=2.0),
    ]
...
def run(cfg: ProfileInvariantConfig) -> pd.DataFrame:
    ...
    out_dir = cfg.base_dir / "nmc_goal_vcorr_it_profile_invariant_results"
    ...
    metadata = {
        **asdict(cfg),
        ...
        "design_intent": "Adversarial drive-cycle head reduces DST/US06 profile shortcuts while SOC head uses only V_corr_raw, I_raw, T.",
...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="Fixed Vcorr/I/T profile-invariant sweep.")
