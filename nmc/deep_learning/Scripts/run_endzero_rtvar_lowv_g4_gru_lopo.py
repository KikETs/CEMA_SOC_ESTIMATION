...
def cfg_for_holdout(holdout: str) -> TrainDSTSelectorConfig:
    prefix = f"endzero_lopo4_rtvar_lowv_ema120_gru_residual_g4_holdout{holdout.lower()}_seed0_b2048_e200"
...
def main() -> None:
    ...
    for holdout in HOLDOUTS:
        ...
        t0 = time.time()
        print(
            f"=== start label=endzero v_corr=rtvar_lowv_ema120 model=GRU_G4_residual "
    ...
    manifest_path = out_dir / "endzero_rtvar_lowv_ema120_g4_gru_lopo_manifest.csv"
